...
class CDFObject implements CDFObjectInterface {
   ...
   *   Object metadata.
   */
  public function __construct($type, $uuid, $created, $modified, $origin, $metadata = []) { // phpcs:ignore
    $this->type = $type;
    $this->uuid = $uuid;
  ...
  public function addAttribute(
    ...
    if ($className !== CDFAttribute::class && !is_subclass_of($className,
        CDFAttribute::class)) {
      $message = sprintf("The %s class must be a subclass of \Acquia\ContentHubClient\CDFAttribute",
        $className);
