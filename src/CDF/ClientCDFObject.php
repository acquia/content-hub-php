...
class ClientCDFObject extends CDFObject
{
     ...
     * @throws \Exception
     */
    public function __construct($uuid, array $settings, array $extradata = [])
    {
        ...
        // Append Any data generated by the client factory
    ...
    /**
     * Grabs the misc data array and returns it to the client
     */
