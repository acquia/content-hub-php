  ...
  protected function getExceptionMessage(
    ...
    if ($exception instanceof RequestException) {
      switch ($method) {
        ...
        case 'createEntity':
          return $this->getErrorResponse(500,
            sprintf('Error trying to create an entity in Content Hub (Error Message: %s)',
              $exception->getMessage()));

        case 'createEntities':
          return $this->getErrorResponse(500,
            sprintf('Error trying to create entities in Content Hub (Error Message = %s)',
              $exception->getMessage()));

        case 'updateEntity':
          return $this->getErrorResponse(500,
            sprintf('Error trying to update entity with UUID="%s" in Content Hub (Error Message = %s)',
              $args[1],
              $exception->getMessage()));
        ...
        case 'deleteEntity':
          return $this->getErrorResponse(500,
            sprintf('Error trying to delete entity with UUID="%s" in Content Hub (Error Message = %s)',
              $args[0],
              $exception->getMessage()));
    ...
    return $this->getErrorResponse(500,
      sprintf('Error trying to connect to the Content Hub (Error Message = %s)',
        $exception->getMessage()));
  }
